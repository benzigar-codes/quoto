export const BACKGROUNDS = [
  ...
  'https://i.pinimg.com/564x/e0/ae/44/e0ae44aba312c58eb790d764dfb0f9ef.jpg',
  'https://i.pinimg.com/736x/80/ec/b3/80ecb3ccd3f5930a123d4c3e6448857f.jpg',
  'https://i.pinimg.com/564x/f9/46/9f/f9469ff47e87909f7f562c6aea008b60.jpg',
  'https://i.pinimg.com/736x/1f/3c/0f/1f3c0fa7a2ebc8252a2f619ad7e8cb6a.jpg',
  'https://i.pinimg.com/564x/0e/c6/97/0ec697c430862054a1e6a3ec9650aa3c.jpg',
  'https://i.pinimg.com/564x/34/d7/b9/34d7b9d7c07c98b6f4aa483f48f7dc7d.jpg',
  'https://i.pinimg.com/564x/10/34/a4/1034a48635ae699f8456da63d68decbe.jpg',
  'https://i.pinimg.com/564x/15/18/65/151865766930d4aa4b2b84d871790094.jpg',
  'https://i.pinimg.com/736x/c7/76/a7/c776a7e7efb052e1b487964bad793830.jpg',
  'https://i.pinimg.com/564x/e0/35/3b/e0353ba2b6f0547c3cd2f50512aacc3b.jpg',
  ...
  'https://i.pinimg.com/736x/7d/0b/81/7d0b815d26da40f8396fa6cd460feef7.jpg',
  ...
  'https://i.pinimg.com/564x/d6/c5/ff/d6c5ff58394b8afb8bc3bc12b3613646.jpg',
  'https://i.pinimg.com/736x/5f/3c/f5/5f3cf56a7cebeb4f9bd830eb06a7bfa6.jpg',
  'https://i.pinimg.com/736x/fa/a3/66/faa3663096d42ca7000d14e17286e803.jpg',
  'https://i.pinimg.com/564x/c0/2d/be/c02dbec373b9d2bedebbf17b647626a5.jpg',
  'https://i.pinimg.com/564x/72/71/f2/7271f2b36f68ccd175a1f9dbd7700e27.jpg',
  'https://i.pinimg.com/564x/69/31/3a/69313ae1044bfb53a2f5c7eeca2d8301.jpg',
  'https://i.pinimg.com/736x/63/20/2a/63202a1d01004278df702a644e04d001.jpg',
];
...
export const generateUniqueID = () => {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    idSegment1 += characters[randomIndex];
  }

  for (let i = 0; i < 4; i++) {
    const randomIndex = Math.floor(Math.random() * characters.length);
    idSegment2 += characters[randomIndex];
  }

  return `${idSegment1}_${idSegment2}`;
};
...
export const getRandomBackground = backgroundImage => {
  ...
  if (backgroundImage)
    backgrounds = BACKGROUNDS?.filter(e => e)?.filter(
      e => e !== backgroundImage,
    );
